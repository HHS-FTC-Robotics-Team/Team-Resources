...
public class Auto2019 extends OpMode { 
    ...
    public void init() {
        right_aft = hardwareMap.dcMotor.get("right_aft");
        left_aft = hardwareMap.dcMotor.get("left_aft");
        right_fore = hardwareMap.dcMotor.get("right_fore");
        left_fore = hardwareMap.dcMotor.get("left_fore");
