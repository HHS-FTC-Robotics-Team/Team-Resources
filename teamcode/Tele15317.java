...
public class Tele15317 extends LinearOpMode {
    ...
    public void runOpMode() {
      ...
      while (opModeIsActive()) {
        //gamepad 1 = drive, collect, flick, foundation
        //gamepad 2 = lift, arm, claw
        ...
        if (-gamepad2.left_stick_y > 0) {
            arm.extend(-gamepad2.left_stick_y);
        } else if (-gamepad2.left_stick_y < 0){
            arm.retract(-gamepad2.left_stick_y);
        } else {
            arm.rest();
        }

        if (-gamepad2.right_stick_y > 0) {
            lift.up(-gamepad2.right_stick_y);
        } else if (-gamepad2.right_stick_y < 0){
            lift.down(-gamepad2.right_stick_y);
        } else {
            lift.rest();
        }
